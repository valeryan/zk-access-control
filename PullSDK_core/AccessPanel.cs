...
public class AccessPanel
{
    ...
    [MethodImpl(MethodImplOptions.Synchronized)]
    public List<Transaction>? ReadTransactionLog(long startingTimestamp)
    {
        if (!IsConnected())
        {
            return null;
